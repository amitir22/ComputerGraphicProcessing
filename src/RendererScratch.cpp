...
{	
    vec4 h_vertex0 = homogoneize_vector(face.vertices[0].position_in_local_space);
    ...
    vec4 h_vertex1 = homogoneize_vector(face.vertices[1].position_in_local_space);
    ...
    vec4 h_vertex2 = homogoneize_vector(face.vertices[2].position_in_local_space);
